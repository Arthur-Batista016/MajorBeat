...
// Novo modelo para os dias do calendário
...
public partial class HirerCalendarViewModel : ObservableObject
{
    ...
    [RelayCommand]
    private async Task AdicionarEvento()
    {
        // Certifique-se de que CreateEventPageView existe
        await Shell.Current.Navigation.PushAsync(new CreateEventPageView());
    }
